...
public class NIOLogReader {
    ...
    public aulas.projects.log_analyzer.LogStatistics analyze(String filePath) {
        Path path = Paths.get(filePath);
        aulas.projects.log_analyzer.LogStatistics stats = new aulas.projects.log_analyzer.LogStatistics(path.getFileName().toString(), "java.nio");
    ...
    private void analyzeWithFilesLines(Path path, aulas.projects.log_analyzer.LogStatistics stats) {
        long lineCount = 0;
    ...
    private void extractLevel(String line, aulas.projects.log_analyzer.LogStatistics stats) {
