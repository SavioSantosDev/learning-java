...
public class IOLogReader {
    ...
    public aulas.projects.log_analyzer.LogStatistics analyze(String filePath) {
        ...
        aulas.projects.log_analyzer.LogStatistics stats = new aulas.projects.log_analyzer.LogStatistics(file.getName(), "java.io");
    ...
    private void analyzeWithBufferedReader(File file, aulas.projects.log_analyzer.LogStatistics stats) {
        long lineCount = 0;
