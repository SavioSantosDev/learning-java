...
public class PerformanceComparator {
    ...
    public void compare(aulas.projects.log_analyzer.LogStatistics ioStats, aulas.projects.log_analyzer.LogStatistics nioStats) {
        System.out.println("\n" + "=".repeat(60));
    ...
    private void compareMetrics(aulas.projects.log_analyzer.LogStatistics ioStats, aulas.projects.log_analyzer.LogStatistics nioStats) {
    ...
    private void saveReport(aulas.projects.log_analyzer.LogStatistics ioStats, aulas.projects.log_analyzer.LogStatistics nioStats) {
